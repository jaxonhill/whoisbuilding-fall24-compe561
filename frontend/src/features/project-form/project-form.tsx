...
import { ProjectFormValues, schema } from "@/utils/project-schema";
...
export function ProjectForm({ defaultValues, onSubmit, submitLabel = "Create project" }: ProjectFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="w-full flex flex-col gap-8 pb-16">
        <FormField
        ...
        >
          <span className="text-white font-medium flex-shrink-0 text-base">{submitLabel}</span>
        </PrimaryButton>
      </form>
    </Form>
  );
